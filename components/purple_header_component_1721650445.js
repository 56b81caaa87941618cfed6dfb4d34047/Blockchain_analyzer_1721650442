            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        <li><a id="Blockchain Explorer-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-slate-300 hover:text-white" href="Blockchain Explorer.html">Blockchain Explorer</a></li>
                        <li><a id="Data Analysis-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-slate-300 hover:text-white" href="Data Analysis.html">Data Analysis</a></li>
                        <li><a id="New Blockchain Info-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-slate-300 hover:text-white" href="New Blockchain Info.html">New Blockchain Info</a></li>
                        <li><a id="API Documentation-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-slate-300 hover:text-white" href="API Documentation.html">API Documentation</a></li>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5 [background:linear-gradient(theme(colors.slate.900),_theme(colors.slate.900))_padding-box,_conic-gradient(theme(colors.slate.400),_theme(colors.slate.700)_25%,_theme(colors.slate.700)_75%,_theme(colors.slate.400)_100%)_border-box]">
                            <li><a id="mobile-Blockchain Explorer-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Blockchain Explorer.html">Blockchain Explorer</a></li>
                            <li><a id="mobile-Data Analysis-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Data Analysis.html">Data Analysis</a></li>
                            <li><a id="mobile-New Blockchain Info-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="New Blockchain Info.html">New Blockchain Info</a></li>
                            <li><a id="mobile-API Documentation-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="API Documentation.html">API Documentation</a></li>
